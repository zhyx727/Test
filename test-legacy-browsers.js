...
function pra_randomtimeRoutineBegin(snapshot) {
  return async function () {
    ...
    pra_randomtimeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_randomtimeRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_randomtimeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
